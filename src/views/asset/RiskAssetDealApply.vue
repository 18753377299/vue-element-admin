<template>
  <div class="app-container">
        ...
        <div style="padding: 15px; text-align:center">
          <el-form
            ...
            <div style="padding: 15px; text-align:right">
              <el-button style="text-align: right" type="primary" @click="handleBuyAddRole" round>增加处理信息</el-button>

              <el-table :data="rolesList" style="width: 100%;margin-top:30px;" border>
                <el-table-column type="selection" width="56" fixed></el-table-column>
                <el-table-column align="center" label="资产编号" width="220">
                ...
                <el-table-column align="center" label="操作"  width="160">
                  <template slot-scope="scope">
                    ...
                    <el-button type="danger" size="small" @click="handleBuyDelete(scope)" round>删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
    ...
    <el-dialog :visible.sync="dialogAssetBuy"  :title="dialogType==='edit'?'资产处理申请':'资产处理申请'">
      <el-form :model="assetBuy" :rules="ruleValidateAssetBuy" label-width="80px" label-position="left">
