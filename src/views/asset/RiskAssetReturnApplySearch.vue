<template>
  <div>
              ...
              <el-col :span="8">
                <el-form-item label="申请类型" prop="companyAddress">
                  <el-select v-model="taskQueryVo.manageType" type="text">
                    ...
                    <el-option value="B" label="报废"></el-option>
                    <el-option value="C" label="部分报废"></el-option>
                    <el-option value="D" label="全部报废"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>
    ...
    <el-dialog :visible.sync="dialogAssetList"  :title="dialogType==='edit'?'资产归还清单':'资产归还清单'">
  ...
  export default {
    ...
    methods: {
      ...
      updateAsset(scope){
         // 跳转到采购申请页面进行修改
//        this.$router.push()
        this.$router.push({path: '/assetmanage/stockreturn', query: {}})
      },
      search() {
        this.showFlag = true
        this.pageNo = 1
