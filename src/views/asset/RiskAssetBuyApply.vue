<template>
  <div class="app-container">
        ...
        <div style="padding: 15px; text-align:center">
          <el-form
            ...
            <div style="padding: 15px; text-align:right">
              <el-button style="text-align: right" type="primary" @click="handleBuyAddRole" round>增加资产信息</el-button>
    ...
    <el-dialog :visible.sync="dialogAssetBuy"  :title="dialogType==='edit'?'资产申请':'资产申请'">
